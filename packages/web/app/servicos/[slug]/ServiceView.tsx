...
function VerseSection({ section, celebration }: { section: ServiceSection; celebration: boolean }) {
 ...
 {section.textAr && (
 <div
 className={`text-right mt-3 leading-loose ${
 celebration ? "text-2xl md:text-3xl leading-[2.2] mt-4" : "text-xl mt-2"
 }`}
 ...
 {/* Transliteration — always visible when present */}
 {section.textArTransliterated && (
 <p
 className={`italic font-ui leading-relaxed ${
 celebration
 ? "text-base md:text-lg text-stone-400 mt-3 leading-relaxed"
