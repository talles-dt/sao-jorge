/* Shared color constants for the Guia Catecumenal — mapped to liturgical theme variables */
export const c = {
  p: "var(--lit-bg)",
  s: "var(--lit-red)",
  a: "var(--lit-gold)",
...
/* Quiz data: Fundamentos, Sacramentos, Espiritualidade */
export const Q = {
  f: {
    t: "Quiz: Fundamentos",
...
/* Section type */
export type SectionId = "bem-vindo" | "fundamentos" | "sacramentos" | "espiritualidade" | "liturgia" | "historia" | "paroxia" | "leituras";
export type QuizKey = "f" | "sac" | "e";
...
/* Styled component type for section props */
export type SectionComponent = (props: { onStart: () => void }) => React.ReactNode;
